...
Первым делом был клонирован форк репозитория на компьютер. После клонирования репозитория в него был добавлен файл через GitHub, затем файл был запулен в локальный репозиторий.
...
\* git clone https://github.com/SUNNSED/LR6
...
!\[Клонирование и пулл репозитория](screenshots/task1-6.png)
...
!\[Создание ветки для отчёта](screenshots/task13-14.png)
...
!\[история операций](screenshots/task15.png)
